package com.zlot.zlotadmin2.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("zlotadmin2");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("zlotadmin2");
        ...
        config.getMapConfigs().put("com.zlot.zlotadmin2.domain.*", initializeDomainMapConfig(jHipsterProperties));
